...
def test_increment_counter(client):
    """Debe incrementar el contador en 1 con PUT y retornar 200 OK."""
...
def test_set_counter(client):
    """Debe fijar el valor del contador en uno específico con PUT y retornar 200 OK."""
...
def test_list_counters(client):
    """Debe listar los contadores con nombres y valores con GET y retornar 200 OK."""
...
def test_reset_counter(client):
    """Debe reiniciar el valor del contador con PUT y retornar 200 OK."""
